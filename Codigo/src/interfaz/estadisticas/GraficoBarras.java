...
public class GraficoBarras extends JPanel implements ActionListener{
    ...
    private CategoryDataset createDataset() {
      ...
      dataset.setValue(A,"", "Enero");
      dataset.setValue(C,"", "Febrero");
      dataset.setValue(L,"", "Marzo");
      dataset.setValue(SJ,"", "Abril");
      dataset.setValue(P,"", "Mayo");
      dataset.setValue(H,"", "Junio");
      dataset.setValue(G,"", "Julio");
      dataset.setValue(G,"", "Agosto");
      dataset.setValue(G,"", "Septiembre");
      dataset.setValue(G,"", "Octubre");
      dataset.setValue(G,"", "Noviemnbre");
      dataset.setValue(G,"", "Diciembre");
      return dataset;
   }
